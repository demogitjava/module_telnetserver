...
class DefaultTheme extends PropertyTheme {
    ...
    private static final String definition = "# This is the default properties\n" +
            ...
            "com.googlecode.lanterna.gui2.DefaultWindowDecorationRenderer.foreground[INSENSITIVE] = white\n" +
            "com.googlecode.lanterna.gui2.DefaultWindowDecorationRenderer.background[INSENSITIVE] = black\n" +
            ...
            "com.googlecode.lanterna.gui2.GUIBackdrop.background = white\n" +
            ...
            "com.googlecode.lanterna.gui2.ProgressBar.background = white\n" +
            ...
            "com.googlecode.lanterna.gui2.TextBox.background = white\n" +
            "\n" +
            "# Window shadow\n" +
